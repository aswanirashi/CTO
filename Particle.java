...
public class Particle extends sim.portrayal.simple.OvalPortrayal2D implements Steppable{
	...
	public Particle(final Double2D loc,String id) {
	...
	public void step(SimState state) {
		...
		suggestedLocation = hb.agentPos[intID];
        ...
        if( dx < 0.5 && dx > -0.5 && dy < 0.5 && dy > -0.5 ){
            steps = 0;
            hb.observerreachedDestination[intID]=true;
        }
